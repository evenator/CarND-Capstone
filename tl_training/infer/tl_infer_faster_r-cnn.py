...
PATH_TO_CKPT = "../train/tl_inference3_faster_r-cnn/frozen_inference_graph.pb"
...
if __name__ == '__main__':
    processVideo('loop_traffic_lights.mp4','./faster_r-cnn_outputs/loop_traffic_lights_out.mp4')
    processVideo('traffic_lights.mp4','./faster_r-cnn_outputs/traffic_lights_out.mp4')
