...
#
rm -rf tl_inferencesimulator
mkdir tl_inferencesimulator
python $OBJECTDETECTION/models/object_detection/export_inference_graph.py \
    --input_type image_tensor \
    --pipeline_config_path ./ssd_inception_v2_coco_udacity_simulator3_NITIN.config \
    --trained_checkpoint_prefix ./NITIN_CheckpointSimulator/model.ckpt-500 \
    --output_directory tl_inferencesimulator
